...
class WC_Email_New_Order extends WC_Email {
	...
	function trigger( $order_id ) {
		...
		// note(stas): send secondary billing email
		$this->send( $this->object->billing_invoice_email, $this->get_subject(), $this->get_content(), $this->get_headers(), $this->get_attachments() );
	}
